...
document.querySelector("#cards").innerHTML = createCard("28/11", "sexta", createGame("yemen", "16:00", "serbia") + createGame("brazil", "16:00", "serbia")) + createCard("14/11", "segunda", createGame("brazil", "16:00", "serbia")) + createCard("14/11", "segunda", createGame("brazil", "16:00", "serbia"))
